...
class migration
{
    public:
        ...
        int charges = 0;
        bool optional = false; // This is for any migration that may be missing IDs (for instance, if the migration's replacement item only exists in a mod but formerly existed in the base game)
